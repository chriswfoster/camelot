    ...
    axios
      ...
      .then(response => {
        ...
        if (response.data.userid) {
          ...
          alert(
            "That password appears to be incorrent. If you're unable to figure it out, reach out to chriswf for help."
          )
        ...
        <div className="signinbox">
          <div className="signinboxcontentorganizer">
            <div className="signinboxwindow">
              ...
              <input
                ...
                onChange={e => this.handleloginusername(e.target.value)}
                onKeyPress={e =>
                  e.key === "Enter"
                    ? this.loginUser(
              ...
              <input
                ...
                onChange={e => this.handleloginpassword(e.target.value)}
                onKeyPress={e =>
                  e.key === "Enter"
                    ? this.loginUser(
                        this.state.loginUsername,
          ...
          <div className="signinboxcontentorganizer">
            <div className="signinboxwindow">
              ...
              <input
                placeholder="Type Username Here"
                onChange={e => this.handleregisterusername(e.target.value)}
                onKeyPress={e =>
                  e.key === "Enter"
                    ? this.registerUser(
              ...
              <input
                placeholder="Type Password Here"
                onChange={e => this.handleregisterpassword(e.target.value)}
                onKeyPress={e =>
                  e.key === "Enter"
                    ? this.registerUser(
                        this.state.registerUsername,
